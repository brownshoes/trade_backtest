...
class TradeResult:
    ...
    def to_dict(self):
        return {
            ...
            "percent_of_position": round(float(self.percent_of_position), 2),
            "total_position_percent_sold": round(float(self.total_position_percent_sold), 2),
            "run_up_dollar": round(float(self.run_up_dollar), 2),
            "run_up_pct": round(float(self.run_up_pct), 2),
            "drawdown_dollar": round(float(self.drawdown_dollar), 2),
            "drawdown_pct": round(float(self.drawdown_pct), 2),
            "profit_and_loss": round(float(self.profit_and_loss), 2),
            "profit_and_loss_pct": round(float(self.profit_and_loss_pct), 2),
        }
